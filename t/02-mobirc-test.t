...
my @TESTCASES = (
    ...
    },
    {
        'params' => [
            'john',
'Your host is simple.poco.server.irc [simple.poco.server.irc/%port%]. AnyEvent::IRC::Server/0.02'
        ],
        'command' => '002',
        'prefix'  => undef
    },
    ...
    {
        'params' =>
          [ 'john', 'simple.poco.server.irc AnyEvent::IRC::Server-0.02' ],
        'command' => '004',
        'prefix'  => undef
    },
    {
    ...
    client => sub {
        ...
        $john->reg_cb(
            ...
            'irc_*' => sub {
                ...
                $expected->{params}->[1] =~ s/%port%/$port/ if scalar(@{$expected->{params}}) > 1;
